...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      // Leaflet and other libs can use very high z-index values (e.g. 1000+).
      // Keep sheets above the rest of the UI.
...
const sheetVariants = cva(
  // Ensure sheet content stays above Leaflet maps/popups/controls.
